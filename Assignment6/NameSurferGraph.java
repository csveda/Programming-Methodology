...
public class NameSurferGraph extends GCanvas
	...
	*/
	...
	/* Method : void addEntry(NameSurferEntry) */
	/**
	 * @param entry
	...
	*/
	...
	/* Method : void drawHorizontalLines() */
	/**
	...
	private void drawHorizontalLines() {
		...
		GLine line1 = new GLine(x1, y1, x2, y1);
		add(line1);
	...
	/* Method : void drawEntry(NameSurferEntry, int) */
	/**
	 * 
	 * @param entry
	 * @param entryNumber
	...
	private void drawEntry(NameSurferEntry entry, int entryNumber) {
		...
		// Add in the label with the Name and Rank number
		for (int i = 0; i < NDECADES; i++) {
